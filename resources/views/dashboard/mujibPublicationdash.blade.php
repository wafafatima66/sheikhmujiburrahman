        ...
        <div class="col-lg-6" style="margin-top: 30px">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$item->title}}</td>
                        <td><textarea cols="15" rows="10" readonly>{{$item->dis}}</textarea></td>
                        <td><img width="100%" src="{{asset('frontEnd/uploads/mujib_Publication')}}/{{$item->photo}}"
                                alt="No Photo" srcset=""></td>
                        <td><a class="btn btn-danger"
                                href="{{url('/delete_mujibPublicationdash/delete')}}/{{$item->id}}">Delete</a></td>
                        <td><a class="btn btn-success"
                                href="{{url('/delete_mujibPublicationdash/edit')}}/{{$item->id}}">Edit</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
