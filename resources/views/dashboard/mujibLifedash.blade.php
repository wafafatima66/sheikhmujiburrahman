        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img width="200" src="{{asset('frontEnd/uploads/mujib_Life')}}/{{$item->photo}}" alt="No Photo"
                            srcset=""></td>
                    <td><a class="btn btn-danger"
                            href="{{url('/delete_mujibLifedash/delete')}}/{{$item->id}}">Delete</a></td>
                    <td><a class="btn btn-success" href="{{url('/delete_mujibLifedash/edit')}}/{{$item->id}}">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
